...
class Bill(ClassBase):
    ...
    def __init__(self, uuid, total_price, order_uuid):
        self.uuid = uuid
    ...
    def create_payment(self, order_uuid, total_price):
        pass

    @classmethod
    def sample(cls):
        return cls(total_price=50000, order_uuid=5, uuid=uuid.uuid4().hex)
